function [Am_X,Am_Y,Am_Z] = get_burner_grid3(wkdir,rmax)

gfile = sprintf('%s/Reactants_grids_0.h5',wkdir);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Blocks in +X direction; 1

%Block 1
dsetname = '/burner/source_blocks/1/x';
a1_X = h5read(gfile,dsetname);
a1_X = permute(a1_X,[3 2 1]);
dsetname = '/burner/source_blocks/1/y';
a1_Y = h5read(gfile,dsetname);
a1_Y = permute(a1_Y,[3 2 1]);
dsetname = '/burner/source_blocks/1/z';
...
Ablk1_X = Ablk1_X(:,:,1:zidx);
Ablk1_Y = Ablk1_Y(:,:,1:zidx);
Ablk1_Z = Ablk1_Z(:,:,1:zidx);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Blocks in +Y direction; 3

%Block 3
dsetname = '/burner/source_blocks/3/x';
a1_X = h5read(gfile,dsetname);
a1_X = permute(a1_X,[3 2 1]);
dsetname = '/burner/source_blocks/3/y';
a1_Y = h5read(gfile,dsetname);
a1_Y = permute(a1_Y,[3 2 1]);
dsetname = '/burner/source_blocks/3/z';
a1_Z = h5read(gfile,dsetname);
a1_Z = permute(a1_Z,[3 2 1]);
...
Ablk2_X = Ablk2_X(:,:,1:zidx);
Ablk2_Y = Ablk2_Y(:,:,1:zidx);
Ablk2_Z = Ablk2_Z(:,:,1:zidx);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Blocks in -X direction; 0

%Block 0
dsetname = '/burner/source_blocks/0/x';
a1_X = h5read(gfile,dsetname);
a1_X = permute(a1_X,[3 2 1]);
dsetname = '/burner/source_blocks/0/y';
a1_Y = h5read(gfile,dsetname);
a1_Y = permute(a1_Y,[3 2 1]);
dsetname = '/burner/source_blocks/0/z';
a1_Z = h5read(gfile,dsetname);
a1_Z = permute(a1_Z,[3 2 1]);
...
Ablk3_X = Ablk3_X(:,:,1:zidx);
Ablk3_Y = Ablk3_Y(:,:,1:zidx);
Ablk3_Z = Ablk3_Z(:,:,1:zidx);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Blocks in -Y direction; 2

%Block 2
dsetname = '/burner/source_blocks/2/x';
a1_X = h5read(gfile,dsetname);
a1_X = permute(a1_X,[3 2 1]);
dsetname = '/burner/source_blocks/2/y';
a1_Y = h5read(gfile,dsetname);
a1_Y = permute(a1_Y,[3 2 1]);
dsetname = '/burner/source_blocks/2/z';
a1_Z = h5read(gfile,dsetname);
a1_Z = permute(a1_Z,[3 2 1]);
...
Ablk4_X = Ablk4_X(:,:,1:zidx);
Ablk4_Y = Ablk4_Y(:,:,1:zidx);
Ablk4_Z = Ablk4_Z(:,:,1:zidx);
