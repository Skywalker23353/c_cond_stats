...
%          FILENAME,          LATEX NAME,                           FIG NAME, WINDOW, N_CYCLES
        ...
        'CH2O','$\langle CH2O|c\rangle$', 5, 2;
        'CH3','$\langle CH3|c\rangle$', 5, 2;
        'CH4','$\langle CH4|c\rangle$', 11, 3;
        'CO','$\langle CO|c\rangle$', 5, 2;
        'CO2','$\langle CO2|c\rangle$', 5, 2;
        'H','$\langle H|c\rangle$', 5, 2;
        'H2O','$\langle H2O|c\rangle$', 5, 2;
        'HO2','$\langle HO2|c\rangle$', 5, 2;
        'N2','$\langle N2|c\rangle$', 5, 2;
        'O','$\langle O|c\rangle$', 5, 2;
