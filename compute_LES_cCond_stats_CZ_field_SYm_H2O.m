...
%% Inputs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LES_start_idx = 201;    LES_end_idx = 1061;
Yu = 0.222606; Yb = 0.0423208;
Y = [Yu,Yb];
delC = 0.0125;  C = (0.0:2e-2:1.0)';
...
field_name ='SYm_H2O';
wkdir = '/work/home/anindya/Anindya_Cases/CH4_jet_PF/2025_Runs/LES_base_case_v6/Chem_src_term_computation';
