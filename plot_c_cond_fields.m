...
% data_dir = '/work/home/satyam/satyam_files/CH4_jet_PF/2025_Runs/c_cond_stats/C_cond_fields_800_10D_n/interpolated';
data_dir = '/work/home/satyam/satyam_files/CH4_jet_PF/2025_Runs/c_cond_stats/C_cond_fields_800_10D_coarse/BC';
%     fields = {
% %          FILENAME,          LATEX NAME,                           FIG NAME
%         'Heatrelease_smooth_interp', '$\langle \dot{\omega}_{T}|c\rangle$', 'Heat Release Rate';
%         'Temperature_smooth_bc_smooth_interp', '$\langle T|c\rangle$', 'Temperature';
%         'density_smooth_bc_smooth_interp','$\langle \rho|c\rangle$', 'density';
% %         'CH2O','$\langle CH2O|c\rangle$', 'CH2O';
% %         'CH3','$\langle CH3|c\rangle$', 'CH3';
%         'CH4_smooth_bc_smooth_interp','$\langle CH4|c\rangle$', 'CH4';
% %         'CO','$\langle CO|c\rangle$', 'CO';
%         'CO2_smooth_bc_smooth_interp','$\langle CO2|c\rangle$', 'CO2';
% %         'H','$\langle H|c\rangle$', 'H';
%         'H2O_smooth_bc_smooth_interp','$\langle H2O|c\rangle$', 'H2O';
% %         'HO2','$\langle HO2|c\rangle$', 'HO2';
% %         'N2','$\langle N2|c\rangle$', 'N2';
% %         'O','$\langle O|c\rangle$', 'O';
%         'O2_smooth_bc_smooth_interp','$\langle O2|c\rangle$', 'O2';
