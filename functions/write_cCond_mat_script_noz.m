function write_cCond_mat_script_noz(varargin)
    ...
    addParameter(p, 'c_vec', [], @isnumeric);
    ...
    script_content = sprintf(['clear all;\n' ...
        ...
        '%% disp(gcp)\n' ...
        '%%%%\n' ...
        '[Na,Nc,R0,C_r,C_z] = getplanar_grid_noz(wkdir,x_lim);\n' ...
        'z_axis = squeeze(C_z(floor(Nc(1)/2)+1,floor(Nc(2)/2)+1,:));\n' ...
        '%%%%\n' ...
        '[Z,DF] = getplanar_cCond_Dist_O2_LES_parallel2_noz(wkdir,field_name,D,Na,Nc,R0,C_r,C_z,LES_start_idx,LES_end_idx,Y,C,delC);\n' ...
        '[C_MAT,Z_MAT] = meshgrid(C,Z);\n' ...
        'DF = DF'';\n' ...
        '%%%%\n' ...
        'save(sprintf(''%%s/%%s.mat'',opDirName,field_name),"DF","C_MAT","Z_MAT");\n' ...
        'toc;\n'], ...
