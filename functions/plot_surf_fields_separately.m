function plot_surf_fields_separately(data_dir,fields,C_MAT,Z_MAT,save_fig,plot_smooth_flag)
    ...
    for i = 1:size(fields, 1)
        ...
        if exist(filepath, 'file')
            ...
            if isfield(data, 'DF')
                myutils.plot_surf_field(fidx, C_MAT, Z_MAT/D, data.DF, '$c$', '$z/D$', colorbar_label);
%                 pbaspect([8 16 1]);
