...
%         'CH3','$\langle CH3|c\rangle$', 'CH3';
        'CH4_smooth_bc_smooth','$\langle CH4|c\rangle$', 'CH4';
%         'CO','$\langle CO|c\rangle$', 'CO';
        'CO2_smooth_bc_smooth','$\langle CO2|c\rangle$', 'CO2';
%         'H','$\langle H|c\rangle$', 'H';
        'H2O_smooth_bc_smooth','$\langle H2O|c\rangle$', 'H2O';
%         'HO2','$\langle HO2|c\rangle$', 'HO2';
%         'N2','$\langle N2|c\rangle$', 'N2';
%         'O','$\langle O|c\rangle$', 'O';
        'O2_smooth_bc_smooth','$\langle O2|c\rangle$', 'O2';
%         'OH','$\langle OH|c\rangle$', 'OH';
%         'H2','$\langle H2|c\rangle$', 'H2';
% 
        'SYm_CH4_smooth','$\langle \dot{\omega}_{CH_4}|c\rangle$', 'SYm_CH4';
        'SYm_O2_smooth','$\langle \dot{\omega}_{O_2}|c\rangle$', 'SYm_O2';
        'SYm_CO2_smooth','$\langle \dot{\omega}_{CO_2}|c\rangle$', 'SYm_CO2';
        'SYm_H2O_smooth','$\langle \dot{\omega}_{H_2O}|c\rangle$', 'SYm_H2O';
