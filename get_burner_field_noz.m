function Am_F = get_burner_field_noz(wkdir,file_idx,field_name,ridx,zidx)
...
%Block 1
dsetname = sprintf('/Reactants/burner/fields/1/%s',field_name);
...
%Block 3
dsetname = sprintf('/Reactants/burner/fields/3/%s',field_name);
a1_F = h5read(outfile,dsetname);
a1_F = permute(a1_F,[3 2 1]);
...
%Block 7
dsetname = sprintf('/Reactants/burner/fields/0/%s',field_name);
a1_F = h5read(outfile,dsetname);
a1_F = permute(a1_F,[3 2 1]);
...
%Block 5
dsetname = sprintf('/Reactants/burner/fields/2/%s',field_name);
a1_F = h5read(outfile,dsetname);
a1_F = permute(a1_F,[3 2 1]);
